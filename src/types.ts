export type ModelAlias = "orin-cheap" | "orin-balanced" | "orin-thinking" | "orin-coding";
export const MODEL_ALIASES: readonly ModelAlias[] = ["orin-cheap", "orin-balanced", "orin-thinking", "orin-coding"];
